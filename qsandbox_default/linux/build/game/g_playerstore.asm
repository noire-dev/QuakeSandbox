...
;40:
;41:/*
;42: *Resets the player store. Should be called everytime game.qvm is loaded.
;43: */
;44:void PlayerStoreInit( void ) {
line 45
;45:    memset(playerstore,0,sizeof(playerstore));
ADDRGP4 playerstore
ARGP4
CNSTI4 0
ARGI4
...
line 49
;48:
;49:void PlayerStore_store(char* guid, playerState_t ps) {
line 50
;50:    int place2store = -1;
ADDRLP4 4
CNSTI4 -1
ASGNI4
line 51
;51:    int lowestAge = 32000;
ADDRLP4 8
CNSTI4 32000
ASGNI4
line 53
;52:    int i;
;53:    if(strlen(guid)<32)
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 12
...
;54:    {
line 55
;55:        G_LogPrintf("Playerstore: Failed to store player. Invalid guid: %s\n",guid);
ADDRGP4 $69
ARGP4
ADDRFP4 0
INDIRP4
...
line 58
;57:    }
;58:    for(i=0;i<MAX_PLAYERS_STORED;i++) {
ADDRLP4 0
CNSTI4 0
ASGNI4
LABELV $70
line 59
;59:        if(!Q_stricmp(guid,playerstore[i].guid)) {
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 236
...
GEI4 $76
line 65
;65:    for(i=0;i<MAX_PLAYERS_STORED;i++) {
ADDRLP4 0
CNSTI4 0
ASGNI4
LABELV $78
line 66
;66:        if(playerstore[i].age < lowestAge) {
CNSTI4 236
ADDRLP4 0
INDIRI4
MULI4
...
ASGNI4
line 68
;68:            lowestAge = playerstore[i].age;
ADDRLP4 8
CNSTI4 236
ADDRLP4 0
INDIRI4
...
line 73
;71:
;72:    //Make sure we don't store in -1
;73:    if(place2store<0)
ADDRLP4 4
INDIRI4
CNSTI4 0
...
LABELV $86
line 76
;75:    //place2store is now the place to store to.
;76:    playerstore[place2store].age = nextAge++;
ADDRLP4 20
ADDRGP4 nextAge
ASGNP4
ADDRLP4 16
...
ASGNI4
line 77
;77:    Q_strncpyz(playerstore[place2store].guid,guid,GUID_SIZE+1);
CNSTI4 236
ADDRLP4 4
INDIRI4
MULI4
...
pop
line 78
;78:    memcpy(playerstore[place2store].persistant,ps.persistant,sizeof(int[MAX_PERSISTANT]));
CNSTI4 236
ADDRLP4 4
INDIRI4
MULI4
...
pop
line 79
;79:    memcpy(playerstore[place2store].accuracy,level.clients[ps.clientNum].accuracy, sizeof(playerstore[0].accuracy) );
CNSTI4 236
ADDRLP4 4
INDIRI4
MULI4
...
pop
line 80
;80:    playerstore[place2store].timePlayed = level.time - level.clients[ps.clientNum].pers.enterTime;
CNSTI4 236
ADDRLP4 4
INDIRI4
MULI4
...
ASGNI4
line 81
;81:    G_LogPrintf("Playerstore: Stored player with guid: %s in %u\n", playerstore[place2store].guid,place2store);
ADDRGP4 $94
ARGP4
CNSTI4 236
ADDRLP4 4
...
line 84
;83:
;84:void PlayerStore_restore(char* guid, playerState_t *ps)  {
line 86
;85:    int i;
;86:    if(strlen(guid)<32)
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 4
...
;87:    {
line 88
;88:        G_LogPrintf("Playerstore: Failed to restore player. Invalid guid: %s\n",guid);
ADDRGP4 $98
ARGP4
ADDRFP4 0
INDIRP4
...
line 91
;90:    }
;91:    for(i=0;i<MAX_PLAYERS_STORED;i++) {
ADDRLP4 0
CNSTI4 0
ASGNI4
LABELV $99
line 92
;92:        if(!Q_stricmpn(guid,playerstore[i].guid,GUID_SIZE) && playerstore[i].age != -1) {
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 236
...
EQI4 $103
line 93
;93:            memcpy(ps->persistant,playerstore[i].persistant,sizeof(int[MAX_PERSISTANT]));
ADDRFP4 4
INDIRP4
CNSTI4 248
ADDP4
...
pop
line 94
;94:            memcpy(level.clients[ps->clientNum].accuracy, playerstore[i].accuracy,sizeof(playerstore[0].accuracy) );
CNSTI4 2324
ADDRFP4 4
INDIRP4
CNSTI4 140
...
pop
line 95
;95:            level.clients[ps->clientNum].pers.enterTime = level.time - playerstore[i].timePlayed;
CNSTI4 2324
ADDRFP4 4
INDIRP4
CNSTI4 140
...
ASGNI4
line 97
;96:            //Never ever restore a player with negative score
;97:            if(ps->persistant[PERS_SCORE]<0)
ADDRFP4 4
INDIRP4
CNSTI4 248
ADDP4
...
ASGNI4
line 100
;100:            G_LogPrintf("Restored player with guid: %s\n",guid);
ADDRGP4 $114
ARGP4
ADDRFP4 0
INDIRP4
...
LTI4 $99
line 104
;104:    G_LogPrintf("Playerstore: Nothing to restore. Guid: %s\n",guid);
ADDRGP4 $115
ARGP4
ADDRFP4 0
INDIRP4
