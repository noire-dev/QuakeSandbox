...
file "../../../code/game/g_fileops.c"
line 35
;1:/*
;2:===========================================================================
;3:Copyright (C) 2009 Karl Kuglin
;4:Copyright (C) 2004-2006 Tony J. White
;5:
;6:This file is part of the Open Arena source code.
;7:Portions copied/modified from Tremulous under GPL version 2 including any
;8:later versions. 
;9:
...
;29:================
;30:readFile_int
;31:This parses an integer for the "tag" specified (cnf)
;32:================
;33:*/
;34:void readFile_int( char **cnf, int *v )
;35:{
line 39
;36:  char *t;
;37:
;38:  //COM_MatchToken(cnf, "=");
;39:  t = COM_ParseExt( cnf, qfalse );
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
;45:  {
line 46
;46:    COM_ParseWarning( "expected '=' before \"%s\"", t );
ADDRGP4 $68
ARGP4
ADDRLP4 0
INDIRP4
...
;52:================
;53:readFile_string
;54:This parses a literal string for the "tag" specified
;55:Color characters and escape sequences are parsed as well. 
;56:================
;57:*/
;58:void readFile_string( char **cnf, char *s, int size )
;59:{
line 63
;60:  char *t;
;61:
;62:  //COM_MatchToken(cnf, "=");
;63:  s[ 0 ] = '\0';
ADDRFP4 4
INDIRP4
CNSTI1 0
...
;66:  {
line 67
;67:    COM_ParseWarning( "expected '=' before \"%s\"", t );
ADDRGP4 $68
ARGP4
ADDRLP4 0
INDIRP4
...
;84:================
;85:writeFile_int
;86:This writes an integer to the file.
;87:Since there is no logic as to where it writes, it must be called "just-in-time."  
;88:================
;89:*/
;90:void writeFile_int( int v, fileHandle_t f )
;91:{
line 94
;92:  char buf[ 32 ];
;93:
;94:  Com_sprintf( buf, sizeof( buf ), "%d", v );
ADDRLP4 0
ARGP4
CNSTI4 32
ARGI4
...
pop
line 95
;95:  trap_FS_Write( buf, strlen( buf ), f );
ADDRLP4 0
ARGP4
ADDRLP4 32
ADDRGP4 strlen
...
;99:/*
;100:================
;101:writeFile_string
;102:This writes a string to the file. 
;103:Since there is no logic as to where it writes, it must be called "just-in-time."
;104:================
;105:*/
;106:void writeFile_string( char *s, fileHandle_t f )
;107:{
line 110
;108:  char buf[ MAX_STRING_CHARS ];
;109:
;110:  buf[ 0 ] = '\0';
ADDRLP4 0
CNSTI1 0
...
;112:  {
line 114
;113:    //Q_strcat(buf, sizeof(buf), s);
;114:    Q_strncpyz( buf, s, sizeof( buf ) );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
pop
line 115
;115:    trap_FS_Write( buf, strlen( buf ), f );
ADDRLP4 0
ARGP4
ADDRLP4 1024
ADDRGP4 strlen
