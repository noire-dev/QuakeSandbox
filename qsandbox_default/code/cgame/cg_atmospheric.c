...
#define MAX_ATMOSPHERIC_HEIGHT			4194304  	// maximum world height (FIXME: since 1.27 this should be 65536)
#define MIN_ATMOSPHERIC_HEIGHT			-4194304  	// minimum world height (FIXME: since 1.27 this should be -65536)
