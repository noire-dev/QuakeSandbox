...
int BotSelectNModWeapon(bot_state_t *bs) {
	int i;
...
void BotChooseWeapon(bot_state_t *bs) {
	if (bs->weaponnum != BotSelectNModWeapon(bs)) bs->weaponchange_time = FloatTime();
	bs->weaponnum = BotSelectNModWeapon(bs);
...
void BotAimAtEnemy(bot_state_t *bs) {
	...
	aim_accuracy = 1.0;		//NMod SIMPLE
	aim_skill = 1.0;		//NMod SIMPLE
	//
